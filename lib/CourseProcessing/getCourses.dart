...
class GetCourses extends StatefulWidget {
  ...
  GetCourses(String subject_, String years_, tri_, String level_,
    ...
    // hesto_geo for science, math , math tech are the same
    if (years_ == 'ثانية ثانوي' || years_ == 'الثالثة ثانوي') {
      if (speciality_ == 'علوم تجريبية' ||
          speciality_ == 'رياضيات' ||
          speciality_ == 'تقني رياضي') {
    ...
    // science, math and math_tech has same phy module
    if (years_ == 'ثانية ثانوي' || years_ == 'الثالثة ثانوي') {
      if (subject_ == 'فيزياء' &&
          (speciality == 'math_tech' || speciality == 'math')) {
        speciality = 'science';
      }
    }

    // science, math and math_tech has same math module
    if (years_ == 'ثانية ثانوي' || years_ == 'الثالثة ثانوي') {
      if (subject_ == 'رياضيات' &&
          (speciality == 'math_tech' || speciality == 'math')) {
        speciality = 'science';
