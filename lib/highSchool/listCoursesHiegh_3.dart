...
class listCoursesHiegh_3 extends StatefulWidget {
  String year = 'الثالثة ثانوي', level;
  listCoursesHiegh_3(this.year, this.level);
  @override
  _FirstYearsState createState() => _FirstYearsState();
}

class _FirstYearsState extends State<listCoursesHiegh_3> {
  // set ads
  @override
  void initState() {
    super.initState();
